...
import iamutkarshtiwari.github.io.ananas.editimage.model.ShapeCatalog;
import iamutkarshtiwari.github.io.ananas.editimage.model.StickerPack;

public class ShapeTypeAdapter extends RecyclerView.Adapter<ViewHolder> {
    private final StickerPack[] shapePacks;
    private final ShapeFragment shapeFragment;
    private final ImageClick imageClick = new ImageClick();

    public ShapeTypeAdapter(ShapeFragment fragment) {
        super();
        this.shapeFragment = fragment;
        shapePacks = ShapeCatalog.getPacks();
    }
    ...
    public void onBindViewHolder(@NotNull ViewHolder holder, int position) {
        ...
        StickerPack shapePack = shapePacks[position];
        imageHolder.text.setText(shapePack.getNameResId());
        imageHolder.text.setTag(shapePack);
    ...
    private final class ImageClick implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (data instanceof StickerPack) {
                shapeFragment.showShapeDetails((StickerPack) data);
            }
        }
    }
}
