...
public final class ModuleConfig {
    ...
    public static final int INDEX_PAINT = 1;
    ...
    public static final int INDEX_STICKER = 6;
    public static final int INDEX_FILTER = 7;
    public static final int INDEX_BRIGHTNESS = 8;
    public static final int INDEX_CONTRAST = 9;
    public static final int INDEX_BEAUTY = 10;
}
